...
router.get("/users/documents/profile",roleMiddleware(["admin","premium","user"]),upload.single("document"),ViewsController.attachFilesProfile);
...
router.get("/users/documents/profile",roleMiddleware(["admin","premium","user"]),ViewsController.attachFilesAddressProof);
router.get("/users/documents/profile",roleMiddleware(["admin","premium","user"]),ViewsController.attachFilesBankStatement);
